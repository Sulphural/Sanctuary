...
public class ClientItemDefinitionCollection : ObservableConcurrentDictionary<int, ClientItemDefinition>
{
    private readonly ILogger _logger;

    public ClientItemDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
