...
public class DailyWheelDefinitionCollection : ObservableConcurrentDictionary<int, DailyWheelDefinition>
{
    private readonly ILogger _logger;

    public DailyWheelDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var list = JsonSerializer.Deserialize<List<DailyWheelDefinition>>(fileStream, jsonSerializerOptions);
