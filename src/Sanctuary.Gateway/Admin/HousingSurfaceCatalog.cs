...
public static class HousingSurfaceCatalog
{
    private static readonly IReadOnlyDictionary<string, int[]> Targets =
        new Dictionary<string, int[]>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [Key("hsg_hum_condo", "Floor")] = [5010],
            [Key("hsg_hum_condo", "Roof")] = [5009],
            [Key("hsg_hum_condo", "Wall")] = [5011],
            [Key("hsg_hum_condo_w_lot", "Floor")] = [5010],
            [Key("hsg_hum_condo_w_lot", "Roof")] = [5009],
            [Key("hsg_hum_condo_w_lot", "Wall")] = [5011],

            [Key("hsg_hum_economy_01", "Floor")] = [5014, 5017],
            [Key("hsg_hum_economy_01", "Roof")] = [5012, 5015, 5018],
            [Key("hsg_hum_economy_01", "Wall")] = [5013, 5016, 5019],

            [Key("hsg_hum_deluxe_01", "Floor")] = [5020, 5023, 5025, 5027],
            [Key("hsg_hum_deluxe_01", "Roof")] = [5021],
            [Key("hsg_hum_deluxe_01", "Wall")] = [5022, 5024, 5026, 5028],

            [Key("hsg_hum_sg_night_club_01", "Floor")] = [5030, 5032, 5034, 5036],
            [Key("hsg_hum_sg_night_club_01", "Roof")] = [5029],
            [Key("hsg_hum_sg_night_club_01", "Wall")] = [5031, 5033, 5035, 5037],

            [Key("hsg_hum_snowhill_01", "Floor")] = [5040, 5041, 5042, 5043, 5044, 5045],
            [Key("hsg_hum_snowhill_01", "Roof")] = [5038],
            [Key("hsg_hum_snowhill_01", "Wall")] = [5039, 5046, 5047, 5048, 5049]
        };
