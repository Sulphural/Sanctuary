...
public static class InventoryPacketItemActionBarAssignHandler
{
    ...
    public static bool HandlePacket(GatewayConnection connection, ReadOnlySpan<byte> data)
    {
        ...
        // TintId - fall back to the item definition's default tint unless this specific instance has its
        // own override (same pattern as Player.ApplyEquipment's attachment tint).
