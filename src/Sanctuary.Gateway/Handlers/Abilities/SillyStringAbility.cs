...
// the shared internal statics it reaches back into (_resourceManager, _logger, IsOnCooldown,
// StartCooldown, SendFailure, ConsumeItem, IconTintId, BoomboxIdleAnimId, _castFxTagCounter) live on
// the old handler.
